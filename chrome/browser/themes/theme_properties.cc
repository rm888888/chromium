...
SkColor GetLightModeColor(int id) {
  ...
  switch (id) {
    ...
    case ThemeProperties::COLOR_STATUS_BUBBLE:
      ...
      //update on 20220613
          return SkColorSetRGB(234,220,233);
      //
      //    return SkColorSetRGB(0xEB, 0xE2, 0xED);
      //update on 20220518
      //case ThemeProperties::COLOR_FRAME_ACTIVE:
      //  return SkColorSetARGB(255,235,226,237);
      //
...
//
    ...
    case ThemeProperties::COLOR_TOOLBAR_TOP_SEPARATOR_INACTIVE:
      ...
      //update on 20220518
      //  return SkColorSetARGB(255,235,226,238);
      //
    ...
    case ThemeProperties::COLOR_OMNIBOX_BACKGROUND:
      //return gfx::kGoogleGrey100;
      //update on 20220518
        return SkColorSetARGB(255,247,244,250);
      //
...
//
    ...
    case ThemeProperties::COLOR_OMNIBOX_TEXT:
      return SK_ColorWHITE;
//
 //         return SkColorSetRGB(185, 183, 186);
//
    case ThemeProperties::COLOR_OMNIBOX_BACKGROUND:
      return gfx::kGoogleGrey900;
 //update on 20220601
    //    return SkColorSetRGB(247, 244, 250);
        //
    default:
      return absl::nullopt;
        //update on 20220601
