#ifndef CHROME_BROWSER_UI_WEBUI_PUNDIX_LANDING_PAGE_LANDINGPAGE_UI_H_
#define CHROME_BROWSER_UI_WEBUI_PUNDIX_LANDING_PAGE_LANDINGPAGE_UI_H_
...
class LandingPageUI : public content::WebUIController {
 public:
  explicit LandingPageUI(content::WebUI* web_ui,const GURL& url);

  LandingPageUI(const LandingPageUI&) = delete;
  LandingPageUI& operator=(const LandingPageUI&) = delete;

  ~LandingPageUI() override;
