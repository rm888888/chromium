...
#ifndef CHROME_BROWSER_UI_VIEWS_EXTENSIONS_EXTENSIONS_SUSPENDBAR_CONTAINER_H_
#define CHROME_BROWSER_UI_VIEWS_EXTENSIONS_EXTENSIONS_SUSPENDBAR_CONTAINER_H_
...
class ExtensionsSuspendbarContainer : public ToolbarIconContainerView,
 ...
 public:
  METADATA_HEADER(ExtensionsSuspendbarContainer);
  ...
  explicit ExtensionsSuspendbarContainer(
      Browser* browser,
      DisplayMode display_mode = DisplayMode::kNormal);
  ExtensionsSuspendbarContainer(const ExtensionsSuspendbarContainer&) = delete;
  ExtensionsSuspendbarContainer& operator=(const ExtensionsSuspendbarContainer&) =
      delete;
  ~ExtensionsSuspendbarContainer() override;
 ...
 private:
  ...
  base::WeakPtrFactory<ExtensionsSuspendbarContainer> weak_ptr_factory_{this};

  base::WeakPtrFactory<ExtensionsSuspendbarContainer> drop_weak_ptr_factory_{this};
};
