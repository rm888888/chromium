...
#ifndef CHROME_BROWSER_UI_VIEWS_PROFILES_PROFILE_WALLET_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_PROFILES_PROFILE_WALLET_VIEW_H_
...
class ProfileWalletView : public views::WidgetDelegateView,
    ...
    //
 public:
  METADATA_HEADER(ProfileWalletView);

  ProfileWalletView(const ProfileWalletView&) = delete;
  ProfileWalletView& operator=(const ProfileWalletView&) = delete;
  ...
  //update on 20220329
  explicit ProfileWalletView(BrowserView* browser_view);
  void Show(const GURL& on_select_profile_target_url,gfx::Rect bounds,views::View* button);
 ...
 private:
  ...
  base::WeakPtrFactory<ProfileWalletView> weak_ptr_factory_{this};
};
