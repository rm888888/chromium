...
#ifndef PROFILE_URL_WEBVIEW_H_
#define PROFILE_URL_WEBVIEW_H_
...
class ProfileUrlWebview : public views::WidgetDelegateView,
                          public ProfilePickerWebContentsHost {
 public:
  METADATA_HEADER(ProfileUrlWebview);

  ProfileUrlWebview(const ProfileUrlWebview&) = delete;
  ProfileUrlWebview& operator=(const ProfileUrlWebview&) = delete;
  ...
  //update on 20220329
  explicit ProfileUrlWebview(BrowserView* browser_view,GURL on_select_profile_target_url,
                             gfx::Size size);
  //update on 20220412
 ...
 private:
  ...
  GURL on_select_profile_target_url_;
    ...
    int kWindowHeight;
    //
  base::WeakPtrFactory<ProfileUrlWebview> weak_ptr_factory_{this};
};
