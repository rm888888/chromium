...
#ifndef CHROME_BROWSER_UI_VIEWS_WALLET_VIEW_BASE_H_
#define CHROME_BROWSER_UI_VIEWS_WALLET_VIEW_BASE_H_
...
class WalletViewBase : public content::WebContentsDelegate,
 ...
 public:
  ...
  enum class ActionableItem {
    ...
    //update on 20220217
    kWalletSignatureButton = 19,
    kMaxValue = kWalletSignatureButton/*kCreateIncognitoShortcutButton*/,
  };
  ...
  static WalletViewBase* GetBubbleForTesting();

  WalletViewBase(views::Button* anchor_button,
                      Browser* browser);
  ~WalletViewBase() override;

  WalletViewBase(const WalletViewBase&) = delete;
  WalletViewBase& operator=(const WalletViewBase&) = delete;
  ...
  //update on 20220217
  void AddWalletButton(const std::u16string& text,
                        base::RepeatingClosure action,
                        const gfx::VectorIcon& icon = gfx::kNoneIcon,
                        float icon_to_image_ratio = 1.0f);
  void AddWalletLabel(const std::u16string& text);
  //
  ...
  //update on 20220216
  void BuildWallet(const std::u16string& title,SkColor profile_background_color);
  //
 ...
 private:
  ...
  //update on 20220216
  views::View* wallet_container_ = nullptr;
  views::View* wallet_title_container_ = nullptr;
  views::View* wallet_show_text_container_ = nullptr;
  views::View* wallet_body_container_ = nullptr;
  //
