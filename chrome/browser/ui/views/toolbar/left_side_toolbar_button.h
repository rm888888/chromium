...
#ifndef CHROME_BROWSER_UI_VIEWS_TOOLBAR_LEFT_SIDE_TOOLBAR_BUTTON_H_
#define CHROME_BROWSER_UI_VIEWS_TOOLBAR_LEFT_SIDE_TOOLBAR_BUTTON_H_
...
class LeftSideToolbarButton : public ToolbarButton,
                               public ReadingListModelObserver {
 public:
  explicit LeftSideToolbarButton(Browser* browser);
  LeftSideToolbarButton(const LeftSideToolbarButton&) = delete;
  LeftSideToolbarButton& operator=(const LeftSideToolbarButton&) = delete;
  ~LeftSideToolbarButton() override;
